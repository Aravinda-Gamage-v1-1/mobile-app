    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.username}>Aravinda Gamage</Text>
                <Text style={styles.email}>aravinda@gmail.com</Text>
            </View>
            ...
            <View style={styles.section}>
                ...
                <View style={styles.row}>
                    ...
                    <Text style={styles.value}>Aravinda Gamage</Text>
                </View>
                <View style={styles.row}>
                    <Text style={styles.label}>Location:</Text>
                    <Text style={styles.value}>Sri Lanka, Galle</Text>
                </View>
            </View>
